...
function video() {
  ...
  useEffect(() => {
    ...
    if (router.query.id_2_ms !== "") {
      setMilliseconds(router.query.id_2_ms);
    }
  ...
  useEffect(() => {
  //  console.log("videos.selected_shot: ", videos.selected_shot);
  ...
  const getOwnedQuestions = (username) => {
    ...
    fetch(`${socket_url}/getquestions`, {
      ...
      .then((res) => res.json())
      .then((res) => {
       // console.log("getQwnedQuestions res : ", res);
        // console.log(res);
          ...
          {Object.values(videos.shots).map((shot, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/*
                    console.log("shot.lst_keyframe_paths: ", shot.lst_keyframe_paths)
                  */}
                  {
